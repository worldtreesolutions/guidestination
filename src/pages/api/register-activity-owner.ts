...
export default async function handler(
    ...
    try {
        ...
        if (ownerCheckError && ownerCheckError.code !== "PGRST116") { // PGRST116 means no rows found, which is fine here.
        ...
        const ownerInsertData: ActivityOwnerInsert = {
            user_id: authData.user.id, // This links to auth.users.id
            // provider_id will be auto-generated by the database if it's the PK with default gen_random_uuid()
        ...
        return res.status(200).json({ 
            message: "Activity owner registered successfully. Please check your email for verification.",
             newOwnerData, // Corrected: Changed to  newOwnerData
            isNewUser: true 
        })
