...
export const categoryService = {
  ...
  async getActivitiesByCategoryId(categoryId: string): Promise<{ data: Activity[] | null; error: any }> {
  ...
  // async createCategory(name: string, description?: string): Promise<{ data: Category | null; error: any }> { ... }
