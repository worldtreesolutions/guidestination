    ...
    <header className='border-b bg-black sticky top-0 z-50 w-full'>
      <div className='max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8'>
        <div className='flex h-16 items-center justify-between'>
          ...
          <div className='flex items-center'>
            <Link href='/dashboard/login' className='hidden md:inline-flex h-10 items-center justify-center rounded-md bg-[#22C55E] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[#1EA34D] focus:outline-none focus:ring-2 focus:ring-[#22C55E] focus:ring-offset-2'>
              Login
            </Link>
