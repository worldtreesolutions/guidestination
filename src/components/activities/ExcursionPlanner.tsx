...
export const ExcursionPlanner = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-primary">Mon Planning Excursion</h1>
        ...
        <DragOverlay dropAnimation={null}>
          {draggedActivity && !isRemoving && (
            <div className="relative w-[150px] h-[200px] rounded-lg overflow-hidden border-2 border-primary bg-white shadow-xl pointer-events-none">
              <Image
